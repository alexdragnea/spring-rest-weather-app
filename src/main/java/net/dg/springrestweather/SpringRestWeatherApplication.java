...
public class SpringRestWeatherApplication {
  ...
  public static void main(String[] args) {
    ...
    //      "IoT", "API", "Aws", "HTTP", "UI", "WiFi", "EN", "BOOT", "I/O", "USB", "UI", "BR",
    // "EDR",
    //      "ROM", "RAM", "SRAM", "KB", "PWM", "ADC", "SPI", "UART", "DAC", "GPIO", "WFA", "WPA",
    // "WAPI",
    //      "OTP", "SHA", "RSA", "EEC", "AES", "RNG", "I2C", "AGL", "VIN", "SCL", "SSID", "JSON",
    // "XML",
    //      "HTML", "CSS", "IAAS", "PAAS", "SAAS", "GMAIL", "EC2", "REST", "URL", "WWW", "URI",
    // "GIT",
    //      "OOP", "JDK", "JVM", "LTS", "POM", "POJO", "CI/CD", "OWASP", "OWM", "QA", "SUT", "E2E",
    // "CSS",
